...
const InfrastructureSport = () => {
  ...
  const normalizeInfrastructureData = (apiInfrastructure) => {
    ...
    // Fallback - пустые данные, если API вернул null
    return {
      name: t(
        "infrastructureSport.name",
        "Современная спортивная инфраструктура КГАФКиС"
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        {/* Dynamic Stats */}
        {infrastructureData.stats.length > 0 && (
          <motion.div
        ...
        {/* Empty State для stats */}
        {infrastructureData.stats.length === 0 &&
          infrastructureData.categories.length > 0 && (
        ...
        {infrastructureData.categories.length > 0 ? (
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-white mb-4">
              {t(
                "infrastructureSport.empty.title",
                "Данные об инфраструктуре отсутствуют"
              )}
            </h3>
            <p className="text-blue-200 text-lg">
              {t(
                "infrastructureSport.empty.subtitle",
                "Информация о спортивной инфраструктуре в настоящее время недоступна"
              )}
            </p>
          </motion.div>
        )}
