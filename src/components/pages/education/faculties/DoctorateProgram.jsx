...
const DepartmentTabs = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await fetch(`https://physical-academy-backend-3dccb860f75a.herokuapp.com/api/education/phd-categories/?lang=${i18n.language}`);
        if (!response.ok) {
  ...
  useEffect(() => {
    ...
    const fetchDepartmentDetails = async () => {
      ...
      try {
        const url = `https://physical-academy-backend-3dccb860f75a.herokuapp.com/api/education/phd-categories/${activeTab}/?lang=${i18n.language}`;
