      ...
      <div className="App">
        ...
        <main className="main-content">
          <Routes>
            ...
            <Route
              path="/academy/accreditation"
              element={<AcademyAccreditation />}
            />
            <Route path="/academy/numbers" element={<AcademyNumbers />} />

            {/* НОВЫЕ ПУТИ ДЛЯ ACADEMY */}
            <Route
              path="/academy/leadership/rectorate"
              element={<AcademyLeadership />}
            />
            <Route
              path="/academy/structure/academic"
              element={<AcademyStructure />}
            />
            <Route
              path="/academy/leadership/board-of-trustees"
              element={<BoardOfTrustees />}
            />
            <Route
              path="/academy/leadership/audit-commission"
              element={<AuditCommission />}
            />
            <Route
              path="/academy/leadership/academic-council"
              element={<AcademicCouncil />}
            />
            <Route
              path="/academy/leadership/trade-union"
              element={<TradeUnion />}
            />
            <Route
              path="/academy/leadership/commissions"
              element={<Commissions />}
            />
            <Route
              path="/academy/structure/administrative"
              element={<AdministrativeStructure />}
            />
            <Route
              path="/academy/structure/units"
            ...
            {/* Admissions routes */}
            <Route
              path="/admissions/bachelor/info"
              element={<BachelorInfo />}
            />
            <Route
              path="/admissions/bachelor/registration"
              element={<BachelorRegistration />}
            />
            <Route
              path="/admissions/bachelor/international"
              element={<BachelorInternational />}
            />
            <Route
              path="/admissions/bachelor/quotas"
              element={<BachelorQuotasFull />}
            />
            <Route
              path="/admissions/bachelor/contacts"
              element={<BachelorContacts />}
            />
            ...
            <Route
              path="/admissions/doctorate/info"
              element={<DoctorateInfo />}
            />

            {/* Education routes */}
            <Route
              path="/education/faculties/pedagogical"
              element={<PedagogicalSports />}
            />
            <Route
              path="/education/faculties/coaching"
              element={<CoachingFaculty />}
            />
            <Route
              path="/education/faculties/military-training"
              element={<MilitaryTraining />}
            />
            <Route
              path="/education/faculties/correspondence"
              element={<CorrespondenceTraining />}
            />
            <Route
              path="/education/departments"
              element={<GeneralDepartments />}
            />
            <Route
              path="/education/college/sports"
              element={<CollegeSports />}
            />

            {/* НОВЫЕ ПУТИ ДЛЯ EDUCATION */}
            <Route
              path="/education/faculties/master"
              element={<MasterProgram />}
            />
            <Route
              path="/education/faculties/doctorate"
              element={<DoctorateProgram />}
            />
            ...
            <Route
              path="/students/disabilities"
              element={<StudentsDisabilities />}
            />
            ...
            <Route
              path="/students/contact-info"
              element={<StudentContactInfo />}
            />
